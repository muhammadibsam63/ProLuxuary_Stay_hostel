export const hotels = [
  {
    ...
    amenities: ["Private Pool", "Sea View", "Spa Access", "Breakfast Included", "Airport Transfer", "Concierge"],
    rooms: [
      { id: "r1", name: "Caldera Suite", size: "42 m²", occupancy: 2, price: 640 },
      { id: "r2", name: "Horizon Villa", size: "68 m²", occupancy: 4, price: 980 },
    ],
  ...
  },
  {
    ...
    amenities: ["Cedar Bath", "Courtyard", "Tea Ceremony", "Bicycle Rental", "Kitchen", "Wi-Fi"],
    rooms: [
      { id: "r1", name: "Tatami Room", size: "28 m²", occupancy: 2, price: 410 },
      { id: "r2", name: "Full Machiya", size: "95 m²", occupancy: 6, price: 1150 },
    ],
  ...
  },
  {
    ...
    amenities: ["Courtyard Pool", "Rooftop Terrace", "Hammam", "Private Chef", "Airport Pickup", "Wi-Fi"],
    rooms: [
      { id: "r1", name: "Courtyard Room", size: "24 m²", occupancy: 2, price: 285 },
      { id: "r2", name: "Rooftop Suite", size: "38 m²", occupancy: 3, price: 420 },
    ],
  ...
  },
  {
    ...
    amenities: ["Sauna", "Fireplace Lounge", "Ski Access", "Mountain View", "Breakfast Included", "Parking"],
    rooms: [
      { id: "r1", name: "Alpine Room", size: "34 m²", occupancy: 2, price: 520 },
      { id: "r2", name: "Summit Suite", size: "60 m²", occupancy: 4, price: 890 },
    ],
  ...
  },
  {
    ...
    amenities: ["Roof Terrace", "River View", "Wi-Fi", "Kitchen", "Self Check-in", "Air Conditioning"],
    rooms: [
      { id: "r1", name: "Tile Room", size: "22 m²", occupancy: 2, price: 230 },
      { id: "r2", name: "Terrace Suite", size: "40 m²", occupancy: 3, price: 365 },
    ],
  ...
  },
  {
    ...
    amenities: ["Infinity Pool", "Jungle View", "Daily Yoga", "Private Chef", "Spa", "Rice Terrace Access"],
    rooms: [
      { id: "r1", name: "Canopy Room", size: "36 m²", occupancy: 2, price: 340 },
      { id: "r2", name: "Ridge Villa", size: "72 m²", occupancy: 4, price: 610 },
    ],
...
export const cities = [
  { name: "Santorini", country: "Greece", image: "https://images.unsplash.com/photo-1570077188670-e3a8d69ac5ff?q=80&w=800&auto=format&fit=crop", count: 18 },
  { name: "Kyoto", country: "Japan", image: "https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?q=80&w=800&auto=format&fit=crop", count: 24 },
  { name: "Marrakech", country: "Morocco", image: "https://images.unsplash.com/photo-1597212720158-2e6d9b5d8a0d?q=80&w=800&auto=format&fit=crop", count: 15 },
  { name: "Banff", country: "Canada", image: "https://images.unsplash.com/photo-1465310477141-6fb93167a273?q=80&w=800&auto=format&fit=crop", count: 9 },
  { name: "Lisbon", country: "Portugal", image: "https://images.unsplash.com/photo-1585208798174-6cedd86e019a?q=80&w=800&auto=format&fit=crop", count: 21 },
  { name: "Ubud", country: "Indonesia", image: "https://images.unsplash.com/photo-1537996194471-e657df975ab4?q=80&w=800&auto=format&fit=crop", count: 17 },
];
